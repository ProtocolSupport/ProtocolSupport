...
public enum ProtocolVersion {
	...
	MINECRAFT_1_11_1(316, new OrderId(ProtocolType.PC, 16), "1.11.1"),
	...
	private static class OrderId implements Comparable<OrderId> {
		...
		public int compareTo(OrderId o) {
			...
			Validate.isTrue(this.type == o.type, "Can't compare order from different types: this - {0}, other - {1}", type, o.type);
