...
public class PECraftingManager {
	...
	public void registerRecipes() {
		...
		Bukkit.recipeIterator().forEachRemaining(recipe -> {
			if (recipe instanceof ShapedRecipe) {
				...
				NetworkItemStack[] required = new NetworkItemStack[shapelessRecipe.getIngredientList().size()];
	...
	public void addRecipeShaped(ByteBuf to, NetworkItemStack output, int width, int height, NetworkItemStack[] required) {
	...
	public void addRecipeShapeless(ByteBuf to, NetworkItemStack output, NetworkItemStack[] required) {
