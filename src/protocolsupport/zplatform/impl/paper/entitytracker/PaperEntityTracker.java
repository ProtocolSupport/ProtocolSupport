...
public class PaperEntityTracker extends EntityTracker {
	...
	public void addEntity(final Entity entity, int i, final int j, final boolean flag) {
		...
		try {
			...
			final EntityTrackerEntry entitytrackerentry = new PaperEntityTrackerEntry(entity, i, this.viewDistance, j, flag);
