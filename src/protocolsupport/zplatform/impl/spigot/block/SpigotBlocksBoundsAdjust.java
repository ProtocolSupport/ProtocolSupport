...
public class SpigotBlocksBoundsAdjust {
	...
	public static void inject() throws IllegalAccessException {
		ReflectionUtils.cloneFields(VoxelShapes.create(0.0625, 0.0, 0.0625, 0.9375, 0.015625, 0.9375), (VoxelShape) ReflectionUtils.getField(BlockWaterLily.class, "a").get(null));
	}
