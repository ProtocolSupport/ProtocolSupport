...
public class PacketEncoder extends AbstractPacketEncoder {
	...
	static {
		...
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SERVER_DIFFICULTY, 0x41);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_COMBAT_EVENT, 0x42);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_CAMERA_ID, 0x43);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_WORLD_BORDER_ID, 0x44);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_TITLE, 0x45);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_PLAYER_LIST_HEADER_FOOTER, 0x47);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_RESOURCE_PACK_ID, 0x48);
	}
