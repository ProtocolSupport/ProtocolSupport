...
public class PacketCodec extends VarIntPacketCodec {
...

	{
		...
		registry.register(ClientBoundPacketType.PLAY_UPDATE_TIME, 0x44);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_EQUIPMENT, 0x3C);
		registry.register(ClientBoundPacketType.PLAY_SPAWN_POSITION, 0x43);
		registry.register(ClientBoundPacketType.PLAY_SET_HEALTH, 0x3E);
		registry.register(ClientBoundPacketType.PLAY_RESPAWN, 0x33);
		registry.register(ClientBoundPacketType.PLAY_POSITION, 0x2E);
		registry.register(ClientBoundPacketType.PLAY_HELD_SLOT, 0x37);
		...
		registry.register(ClientBoundPacketType.PLAY_COLLECT_EFFECT, 0x48);
		...
		registry.register(ClientBoundPacketType.PLAY_ENTITY_VELOCITY, 0x3B);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_DESTROY, 0x30);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_REL_MOVE, 0x25);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_LOOK, 0x27);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_REL_MOVE_LOOK, 0x26);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_TELEPORT, 0x49);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_HEAD_ROTATION, 0x34);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_STATUS, 0x1B);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_LEASH, 0x3A);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_METADATA, 0x39);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_EFFECT_ADD, 0x4B);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_EFFECT_REMOVE, 0x31);
		registry.register(ClientBoundPacketType.PLAY_SET_EXPERIENCE, 0x3D);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_ATTRIBUTES, 0x4A);
		...
		registry.register(ClientBoundPacketType.PLAY_WORLD_SOUND, 0x46);
		...
		registry.register(ClientBoundPacketType.PLAY_SCOREBOARD_OBJECTIVE, 0x3F);
		registry.register(ClientBoundPacketType.PLAY_SCOREBOARD_SCORE, 0x42);
		registry.register(ClientBoundPacketType.PLAY_SCOREBOARD_DISPLAY_SLOT, 0x38);
		registry.register(ClientBoundPacketType.PLAY_SCOREBOARD_TEAM, 0x41);
		...
		registry.register(ClientBoundPacketType.PLAY_CAMERA, 0x36);
		registry.register(ClientBoundPacketType.PLAY_WORLDBORDER_INIT, 0x35);
		registry.register(ClientBoundPacketType.PLAY_WORLDBORDER_CENTER, 0x35);
		registry.register(ClientBoundPacketType.PLAY_WORLDBORDER_LERP_SIZE, 0x35);
		registry.register(ClientBoundPacketType.PLAY_WORLDBORDER_SIZE, 0x35);
		registry.register(ClientBoundPacketType.PLAY_WORLDBORDER_WARN_DELAY, 0x35);
		registry.register(ClientBoundPacketType.PLAY_WORLDBORDER_WARN_DISTANCE, 0x35);
		...
		registry.register(ClientBoundPacketType.PLAY_ACTIONBAR, 0x45);
		registry.register(ClientBoundPacketType.PLAY_PLAYER_LIST_HEADER_FOOTER, 0x47);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_PASSENGERS, 0x40);
