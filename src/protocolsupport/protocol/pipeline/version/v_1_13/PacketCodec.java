...
public class PacketCodec extends VarIntPacketCodec {
...

	{
		...
		registry.register(ClientBoundPacketType.PLAY_PLAYER_MESSAGE, 0x0E);
		...
		registry.register(ClientBoundPacketType.LEGACY_PLAY_USE_BED, 0x33);
		...
		registry.register(ClientBoundPacketType.PLAY_PLAYER_LIST_ENTRY_UPDATE, 0x30);
