...
public class PacketCodec extends ModernPacketCodec {
...

	{
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_UPDATE_TIME, 0x46);
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_EQUIPMENT, 0x3E);
		registry.register(PacketType.CLIENTBOUND_PLAY_SPAWN_POSITION, 0x45);
		registry.register(PacketType.CLIENTBOUND_PLAY_UPDATE_HEALTH, 0x40);
		registry.register(PacketType.CLIENTBOUND_PLAY_RESPAWN, 0x34);
		registry.register(PacketType.CLIENTBOUND_PLAY_POSITION, 0x2E);
		registry.register(PacketType.CLIENTBOUND_PLAY_HELD_SLOT, 0x39);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_COLLECT_EFFECT, 0x4A);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_VELOCITY, 0x3D);
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_DESTROY, 0x31);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_TELEPORT, 0x4B);
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_HEAD_ROTATION, 0x35);
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_STATUS, 0x1B);
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_LEASH, 0x3C);
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_METADATA, 0x3B);
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_EFFECT_ADD, 0x4E);
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_EFFECT_REMOVE, 0x32);
		registry.register(PacketType.CLIENTBOUND_PLAY_EXPERIENCE, 0x3F);
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_ATTRIBUTES, 0x4D);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLD_SOUND, 0x48);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_ABILITIES, 0x2B);
		registry.register(PacketType.CLIENTBOUND_PLAY_TAB_COMPLETE, 0xE);
		registry.register(PacketType.CLIENTBOUND_PLAY_SCOREBOARD_OBJECTIVE, 0x41);
		registry.register(PacketType.CLIENTBOUND_PLAY_SCOREBOARD_SCORE, 0x44);
		registry.register(PacketType.CLIENTBOUND_PLAY_SCOREBOARD_DISPLAY_SLOT, 0x3A);
		registry.register(PacketType.CLIENTBOUND_PLAY_SCOREBOARD_TEAM, 0x43);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_RESOURCE_PACK, 0x33);
		registry.register(PacketType.CLIENTBOUND_PLAY_CAMERA, 0x38);
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLD_BORDER, 0x37);
		registry.register(PacketType.CLIENTBOUND_PLAY_TITLE, 0x47);
		registry.register(PacketType.CLIENTBOUND_PLAY_PLAYER_LIST_HEADER_FOOTER, 0x49);
		registry.register(PacketType.CLIENTBOUND_PLAY_SET_PASSENGERS, 0x42);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_UNLOCK_RECIPES, 0x30);
		registry.register(PacketType.CLIENTBOUND_PLAY_ADVANCEMENTS, 0x4C);
		registry.register(PacketType.CLIENTBOUND_PLAY_ADVANCEMENTS_TAB, 0x36);
	}
