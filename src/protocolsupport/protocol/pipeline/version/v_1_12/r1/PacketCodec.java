...
public class PacketCodec extends VarIntPacketCodec {
...

	{
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLDBORDER_INIT, 0x37);
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLDBORDER_CENTER, 0x37);
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLDBORDER_LERP_SIZE, 0x37);
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLDBORDER_SIZE, 0x37);
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLDBORDER_WARN_DELAY, 0x37);
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLDBORDER_WARN_DISTANCE, 0x37);
		registry.register(PacketType.CLIENTBOUND_PLAY_TITLE_TEXT, 0x47);
		registry.register(PacketType.CLIENTBOUND_PLAY_TITLE_SUBTEXT, 0x47);
		registry.register(PacketType.CLIENTBOUND_PLAY_TITLE_ANIMATION, 0x47);
		registry.register(PacketType.CLIENTBOUND_PLAY_TITLE_CLEAR, 0x47);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_COMBAT_BEGIN, 0x2C);
		registry.register(PacketType.CLIENTBOUND_PLAY_COMBAT_END, 0x2C);
		registry.register(PacketType.CLIENTBOUND_PLAY_COMBAT_DEATH, 0x2C);
