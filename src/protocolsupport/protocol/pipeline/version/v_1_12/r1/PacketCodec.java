...
public class PacketCodec extends ModernPacketCodec {
...

	{
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_SET_HEALTH, 0x40);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_SET_EXPERIENCE, 0x3F);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_PASSENGERS, 0x42);
