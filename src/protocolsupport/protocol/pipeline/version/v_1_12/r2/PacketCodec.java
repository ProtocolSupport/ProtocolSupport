...
public class PacketCodec extends ModernPacketCodec {
...

	{
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_SET_HEALTH, 0x41);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_NOOP, 0x25);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_SET_EXPERIENCE, 0x40);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_PLAYER_ABILITIES, 0x2C);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_PASSENGERS, 0x43);
