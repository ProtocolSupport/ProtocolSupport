...
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_9r1_9r2_10_11_12r1_12r2.MerchantTradeList;
...
public class PacketEncoder extends AbstractModernPacketEncoder {
	...
	static {
		...
		packetIdRegistry.register(NetworkState.PLAY, ClientBoundPacket.LEGACY_PLAY_USE_BED_ID, 0x30);
		...
		packetIdRegistry.register(NetworkState.PLAY, ClientBoundPacket.PLAY_CRAFT_RECIPE_CONFIRM, 0x2B);
	}
