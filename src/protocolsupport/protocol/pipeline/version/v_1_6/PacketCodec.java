...
public class PacketCodec extends BytePacketCodec {
...

	{
		...
		registry.register(ClientBoundPacketType.PLAY_CHAT, 0x03);
		...
		registry.register(ClientBoundPacketType.PLAY_SPAWN_OBJECT, 0x17);
		registry.register(ClientBoundPacketType.PLAY_SPAWN_LIVING, 0x18);
		registry.register(ClientBoundPacketType.PLAY_SPAWN_PAINTING, 0x19);
		...
		registry.register(ClientBoundPacketType.PLAY_ENTITY_ATTRIBUTES, 0x2C);
		...
		registry.register(ClientBoundPacketType.PLAY_WORLD_CUSTOM_SOUND, 0x3E);
		...
		registry.register(ClientBoundPacketType.PLAY_SIGN_EDITOR, 0x85);
		registry.register(ClientBoundPacketType.PLAY_PLAYER_INFO, 0xC9);
