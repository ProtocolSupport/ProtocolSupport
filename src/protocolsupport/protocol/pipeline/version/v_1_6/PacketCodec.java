...
public class PacketCodec extends LegacyPacketCodec {
...

	{
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_UPDATE_HEALTH, 0x08);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_ANIMATION, 0x12);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY, 0x1E);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_EXPERIENCE, 0x2B);
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_ATTRIBUTES, 0x2C);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_SPAWN_WEATHER, 0x47);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_MAP, 0x83);
		registry.register(PacketType.CLIENTBOUND_PLAY_UPDATE_TILE, 0x84);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_ABILITIES, 0xCA);
