...
public class PacketEncoder extends AbstractPacketEncoder {
...

	{
		...
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_COMBAT_BEGIN, NoopCombatBegin::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_COMBAT_END, NoopCombatEnd::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_COMBAT_DEATH, NoopCombatDeath::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_WORLDBORDER_INIT, NoopWorldBorderInit::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_WORLDBORDER_CENTER, NoopWorldBorderCenter::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_WORLDBORDER_LERP_SIZE, NoopWorldBorderLerpSize::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_WORLDBORDER_SIZE, NoopWorldBorderSize::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_WORLDBORDER_WARN_DELAY, NoopWorldBorderWarnDelay::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_WORLDBORDER_WARN_DISTANCE, NoopWorldBorderWarnDistance::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_TITLE_TEXT, NoopTitleText::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_TITLE_SUBTEXT, NoopTitleSubText::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_TITLE_ANIMATION, NoopTitleAnimation::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_TITLE_CLEAR, NoopTitleClear::new);
		registry.register(NetworkState.PLAY, PacketType.CLIENTBOUND_PLAY_ACTIONBAR, NoopActionbar::new);
