...
public class PacketCodec extends VarIntPacketCodec {
...

	{
		...
		registry.register(ClientBoundPacketType.PLAY_PLAYER_MESSAGE, 0x02);
		...
		registry.register(ClientBoundPacketType.LEGACY_PLAY_USE_BED, 0x0A);
		...
		registry.register(ClientBoundPacketType.LEGACY_PLAY_SPAWN_OBJECT, 0x0E);
		registry.register(ClientBoundPacketType.PLAY_SPAWN_ENTITY, 0x0F);
		registry.register(ClientBoundPacketType.LEGACY_PLAY_SPAWN_PAINTING, 0x10);
		...
		registry.register(ClientBoundPacketType.LEGACY_PLAY_WORLD_CUSTOM_SOUND, 0x29);
		...
		registry.register(ClientBoundPacketType.LEGACY_PLAY_SPAWN_GLOBAL, 0x2C);
		...
		registry.register(ClientBoundPacketType.LEGACY_PLAY_WINDOW_TRANSACTION, 0x32);
		registry.register(ClientBoundPacketType.LEGACY_PLAY_UPDATE_SIGN, 0x33);
		...
		registry.register(ClientBoundPacketType.PLAY_PLAYER_LIST_ENTRY_UPDATE, 0x38);
