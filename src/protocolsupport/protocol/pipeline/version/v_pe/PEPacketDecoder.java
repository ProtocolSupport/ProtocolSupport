...
import protocolsupport.protocol.packet.middleimpl.serverbound.play.v_pe.BlockEntityData;
...
public class PEPacketDecoder extends AbstractPacketDecoder {

	{
		...
		registry.register(NetworkState.PLAY, PEPacketIDs.BLOCK_ENTITY_DATA, BlockEntityData.class);
	}
