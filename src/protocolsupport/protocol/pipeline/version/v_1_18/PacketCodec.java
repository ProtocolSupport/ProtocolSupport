...
public class PacketCodec extends VarIntPacketCodec {
...

	{
		...
		registry.register(ClientBoundPacketType.PLAY_UPDATE_TIME, 0x59);
		...
		registry.register(ClientBoundPacketType.PLAY_COLLECT_EFFECT, 0x61);
		...
		registry.register(ClientBoundPacketType.PLAY_ENTITY_TELEPORT, 0x62);
		...
		registry.register(ClientBoundPacketType.PLAY_ENTITY_ATTRIBUTES, 0x64);
		...
		registry.register(ClientBoundPacketType.PLAY_ENTITY_EFFECT_ADD, 0x65);
		...
		registry.register(ClientBoundPacketType.PLAY_ENTITY_SOUND, 0x5C);
		...
		registry.register(ClientBoundPacketType.PLAY_WORLD_SOUND, 0x5D);
		...
		registry.register(ClientBoundPacketType.PLAY_PLAYER_LIST_HEADER_FOOTER, 0x5F);
		...
		registry.register(ClientBoundPacketType.PLAY_ADVANCEMENTS, 0x63);
		...
		registry.register(ClientBoundPacketType.PLAY_DECLARE_RECIPES, 0x66);
		registry.register(ClientBoundPacketType.PLAY_DECLARE_TAGS, 0x67);
		registry.register(ClientBoundPacketType.PLAY_QUERY_NBT_RESPONSE, 0x60);
		registry.register(ClientBoundPacketType.PLAY_STOP_SOUND, 0x5E);
		...
		registry.register(ClientBoundPacketType.PLAY_UPDATE_SIMULATION_DISTANCE, 0x57);
		...
		registry.register(ClientBoundPacketType.PLAY_TITLE_TEXT, 0x5A);
		registry.register(ClientBoundPacketType.PLAY_TITLE_SUBTEXT, 0x58);
		registry.register(ClientBoundPacketType.PLAY_TITLE_ANIMATION, 0x5B);
