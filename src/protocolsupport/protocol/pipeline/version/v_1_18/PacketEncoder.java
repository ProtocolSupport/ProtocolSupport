...
public class PacketEncoder extends AbstractPacketEncoder<IClientboundMiddlePacketV18> {
	...
	public PacketEncoder(IPacketDataChannelIO io, NetworkDataCache cache) {
		...
		registry.register(NetworkState.PLAY, ClientBoundPacketType.PLAY_UPDATE_SIMULATION_DISTANCE, UpdateSimulationDistance::new);
