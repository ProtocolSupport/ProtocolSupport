...
public class PacketEncoder extends AbstractPacketEncoder {
...

	{
		...
		registry.register(NetworkState.LOGIN, ClientBoundPacketType.CLIENTBOUND_LOGIN_CUSTOM_PAYLOAD, LoginCustomPayload::new);
		...
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_UNLOCK_RECIPES, UnlockRecipes::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_CRAFT_RECIPE_CONFIRM, CraftRecipeConfirm::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_STATISTICS, Statistics::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_DECLARE_COMMANDS, DeclareCommands::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_DECLARE_RECIPES, DeclareRecipes::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_DECLARE_TAGS, DeclareTags::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_QUERY_NBT_RESPONSE, QueryNBTResponse::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_STOP_SOUND, StopSound::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_LOOK_AT, LookAt::new);
		...
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_SET_VIEW_CENTER, SetViewCenter::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_UPDATE_VIEW_DISTANCE, UpdateViewDistance::new);
