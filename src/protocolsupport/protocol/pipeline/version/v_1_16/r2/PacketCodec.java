...
public class PacketCodec extends VarIntPacketCodec {
...

	{
		...
		registry.register(ClientBoundPacketType.PLAY_SET_COOLDOWN, 0x16);
		registry.register(ClientBoundPacketType.PLAY_RESPAWN, 0x39);
		registry.register(ClientBoundPacketType.PLAY_POSITION, 0x34);
		...
		registry.register(ClientBoundPacketType.PLAY_ENTITY_REL_MOVE, 0x27);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_LOOK, 0x29);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_REL_MOVE_LOOK, 0x28);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_TELEPORT, 0x56);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_HEAD_ROTATION, 0x3A);
		...
		registry.register(ClientBoundPacketType.PLAY_ENTITY_ANIMATION, 0x5);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_EFFECT_ADD, 0x59);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_EFFECT_REMOVE, 0x37);
		...
		registry.register(ClientBoundPacketType.PLAY_CHUNK_LIGHT, 0x23);
		registry.register(ClientBoundPacketType.PLAY_BLOCK_CHANGE_MULTI, 0x3B);
		...
		registry.register(ClientBoundPacketType.PLAY_EXPLOSION, 0x1B);
		...
		registry.register(ClientBoundPacketType.PLAY_GAME_STATE_CHANGE, 0x1D);
		registry.register(ClientBoundPacketType.PLAY_WINDOW_OPEN, 0x2D);
		registry.register(ClientBoundPacketType.PLAY_WINDOW_HORSE_OPEN, 0x1E);
		...
		registry.register(ClientBoundPacketType.PLAY_KICK_DISCONNECT, 0x19);
		registry.register(ClientBoundPacketType.PLAY_RESOURCE_PACK, 0x38);
		...
		registry.register(ClientBoundPacketType.PLAY_COMBAT_DEATH, 0x31);
		registry.register(ClientBoundPacketType.PLAY_BOSS_BAR, 0xC);
		registry.register(ClientBoundPacketType.PLAY_VEHICLE_MOVE, 0x2B);
		registry.register(ClientBoundPacketType.PLAY_UNLOCK_RECIPES, 0x35);
		...
		registry.register(ClientBoundPacketType.PLAY_CRAFT_RECIPE_CONFIRM, 0x2F);
		...
		registry.register(ClientBoundPacketType.PLAY_LOOK_AT, 0x33);
