...
public class PacketEncoder extends AbstractPacketEncoder {
...

	{
		...
		registry.register(NetworkState.LOGIN, ClientBoundPacketType.CLIENTBOUND_LOGIN_SET_COMPRESSION, NoopSetCompression::new);
		registry.register(NetworkState.LOGIN, ClientBoundPacketType.CLIENTBOUND_LOGIN_SUCCESS, NoopLoginSuccess::new);
		...
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_ENTITY_LEASH, NoopEntityLeash::new);
		...
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_SERVER_DIFFICULTY, NoopServerDifficulty::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_COMBAT_BEGIN, NoopCombatBegin::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_COMBAT_END, NoopCombatEnd::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_COMBAT_DEATH, NoopCombatDeath::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_WORLDBORDER_INIT, NoopWorldBorderInit::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_WORLDBORDER_CENTER, NoopWorldBorderCenter::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_WORLDBORDER_LERP_SIZE, NoopWorldBorderLerpSize::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_WORLDBORDER_SIZE, NoopWorldBorderSize::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_WORLDBORDER_WARN_DELAY, NoopWorldBorderWarnDelay::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_WORLDBORDER_WARN_DISTANCE, NoopWorldBorderWarnDistance::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_TITLE_TEXT, NoopTitleText::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_TITLE_SUBTEXT, NoopTitleSubText::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_TITLE_ANIMATION, NoopTitleAnimation::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_TITLE_CLEAR, NoopTitleClear::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_ACTIONBAR, NoopActionbar::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_PLAYER_LIST_HEADER_FOOTER, NoopPlayerListHeaderFooter::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_CAMERA, NoopCamera::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_SET_COOLDOWN, NoopSetCooldown::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_BOSS_BAR, NoopBossBar::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_VEHICLE_MOVE, NoopVehicleMove::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_STATISTICS, NoopStatistics::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_RESOURCE_PACK, NoopResourcePack::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_SIGN_EDITOR, NoopBlockOpenSignEditor::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_ENTITY_ATTRIBUTES, NoopEntityAttributes::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_WORLD_PARTICLES, NoopWorldParticle::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_SCOREBOARD_DISPLAY_SLOT, NoopScoreboardDisplay::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_SCOREBOARD_SCORE, NoopScoreboardScore::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_SCOREBOARD_OBJECTIVE, NoopScoreboardObjective::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_SCOREBOARD_TEAM, NoopScoreboardTeam::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_UNLOCK_RECIPES, NoopUnlockRecipes::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_ADVANCEMENTS, NoopAdvancements::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.CLIENTBOUND_PLAY_ADVANCEMENTS_TAB, NoopAdvanementsTab::new);
