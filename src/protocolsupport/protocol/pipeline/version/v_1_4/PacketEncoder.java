...
public class PacketEncoder extends AbstractPacketEncoder {
...

	{
		...
		registry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_WORLD_PARTICLES_ID, NoopWorldParticle.class);
		registry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SCOREBOARD_DISPLAY_SLOT_ID, NoopScoreboardDisplay.class);
		registry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SCOREBOARD_SCORE_ID, NoopScoreboardScore.class);
		registry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SCOREBOARD_OBJECTIVE_ID, NoopScoreboardObjective.class);
		registry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SCOREBOARD_TEAM_ID, NoopScoreboardTeam.class);
	}
