...
public class PipeLineBuilder implements IPipeLineBuilder {
	...
	@Override
	public void buildPipeLine(Channel channel, Connection connecton) {
		...
		ChannelHandlers.getDecoder(pipeline).setRealDecoder(new PacketDecoder(connecton, sharedstorage));
		ChannelHandlers.getEncoder(pipeline).setRealEncoder(new PacketEncoder(connecton, sharedstorage));
	}
