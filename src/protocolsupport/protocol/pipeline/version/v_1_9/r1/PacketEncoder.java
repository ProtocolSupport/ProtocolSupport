...
public class PacketEncoder extends AbstractPacketEncoder {
	...
	static {
		...
		packetIdRegistry.register(NetworkListenerState.LOGIN, ClientBoundPacket.LOGIN_SET_COMPRESSION_ID, 0x03);
		...
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SPAWN_OBJECT_ID, 0x00);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SPAWN_EXP_ORB_ID, 0x01);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SPAWN_WEATHER_ID, 0x02);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SPAWN_LIVING_ID, 0x03);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SPAWN_PAINTING_ID, 0x04);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SPAWN_NAMED_ID, 0x05);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ANIMATION_ID, 0x06);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_STATISTICS, 0x07);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_BLOCK_BREAK_ANIMATION_ID, 0x08);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_UPDATE_TILE_ID, 0x09);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_BLOCK_ACTION_ID, 0x0A);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_BLOCK_CHANGE_SINGLE_ID, 0x0B);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_BOSS_BAR, 0x0C);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SERVER_DIFFICULTY, 0x0D);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_TAB_COMPLETE_ID, 0x0E);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_CHAT_ID, 0x0F);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_BLOCK_CHANGE_MULTI_ID, 0x10);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_WINDOW_TRANSACTION_ID, 0x11);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_WINDOW_CLOSE_ID, 0x12);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_WINDOW_OPEN_ID, 0x13);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_WINDOW_SET_ITEMS_ID, 0x14);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_WINDOW_DATA_ID, 0x15);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_WINDOW_SET_SLOT_ID, 0x16);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SET_COOLDOWN, 0x17);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_CUSTOM_PAYLOAD_ID, 0x18);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_WORLD_CUSTOM_SOUND, 0x19);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_KICK_DISCONNECT_ID, 0x1A);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_STATUS_ID, 0x1B);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_EXPLOSION_ID, 0x1C);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_CHUNK_UNLOAD, 0x1D);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_GAME_STATE_CHANGE_ID, 0x1E);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_KEEP_ALIVE_ID, 0x1F);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_CHUNK_SINGLE_ID, 0x20);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_WORLD_EVENT_ID, 0x21);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_WORLD_PARTICLES_ID, 0x22);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_LOGIN_ID, 0x23);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_MAP_ID, 0x24);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_REL_MOVE_ID, 0x25);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_REL_MOVE_LOOK_ID, 0x26);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_LOOK_ID, 0x27);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_ID, 0x28);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_VEHICLE_MOVE, 0x29);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SIGN_EDITOR_ID, 0x2A);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ABILITIES_ID, 0x2B);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_COMBAT_EVENT, 0x2C);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_PLAYER_INFO_ID, 0x2D);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_POSITION_ID, 0x2E);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_BED_ID, 0x2F);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_DESTROY_ID, 0x30);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_EFFECT_REMOVE_ID, 0x31);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_RESOURCE_PACK_ID, 0x32);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_RESPAWN_ID, 0x33);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_HEAD_ROTATION_ID, 0x34);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_WORLD_BORDER_ID, 0x35);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_CAMERA_ID, 0x36);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_HELD_SLOT_ID, 0x37);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SCOREBOARD_DISPLAY_SLOT_ID, 0x38);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_METADATA_ID, 0x39);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_LEASH_ID, 0x3A);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_VELOCITY_ID, 0x3B);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_EQUIPMENT_ID, 0x3C);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_EXPERIENCE_ID, 0x3D);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_UPDATE_HEALTH_ID, 0x3E);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SCOREBOARD_OBJECTIVE_ID, 0x3F);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SET_PASSENGERS, 0x40);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SCOREBOARD_TEAM_ID, 0x41);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SCOREBOARD_SCORE_ID, 0x42);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SPAWN_POSITION_ID, 0x43);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_UPDATE_TIME_ID, 0x44);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_TITLE, 0x45);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.LEGACY_PLAY_UPDATE_SIGN_ID, 0x46);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_PLAYER_LIST_HEADER_FOOTER, 0x48);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_COLLECT_EFFECT_ID, 0x49);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_TELEPORT_ID, 0x4A);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_ATTRIBUTES_ID, 0x4B);
		packetIdRegistry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_EFFECT_ADD_ID, 0x4C);
	}
