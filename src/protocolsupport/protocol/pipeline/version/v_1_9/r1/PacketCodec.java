...
public class PacketCodec extends VarIntPacketCodec {
...

	{
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLDBORDER_INIT, 0x35);
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLDBORDER_CENTER, 0x35);
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLDBORDER_LERP_SIZE, 0x35);
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLDBORDER_SIZE, 0x35);
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLDBORDER_WARN_DELAY, 0x35);
		registry.register(PacketType.CLIENTBOUND_PLAY_WORLDBORDER_WARN_DISTANCE, 0x35);
