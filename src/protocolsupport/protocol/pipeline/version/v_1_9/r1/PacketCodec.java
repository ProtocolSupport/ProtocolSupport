...
public class PacketCodec extends VarIntPacketCodec {
...

	{
		...
		registry.register(ClientBoundPacketType.PLAY_BLOCK_TILE, 0x09);
		registry.register(ClientBoundPacketType.PLAY_BLOCK_ACTION, 0x0A);
		registry.register(ClientBoundPacketType.PLAY_BLOCK_CHANGE_SINGLE, 0x0B);
		...
		registry.register(ClientBoundPacketType.PLAY_ENTITY_ATTRIBUTES, 0x4B);
		registry.register(ClientBoundPacketType.PLAY_ENTITY_EFFECT_ADD, 0x4C);
	}
