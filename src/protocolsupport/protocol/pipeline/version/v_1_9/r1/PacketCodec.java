...
public class PacketCodec extends ModernPacketCodec {
...

	{
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_SPAWN_OBJECT, 0x00);
		registry.register(PacketType.CLIENTBOUND_PLAY_SPAWN_EXP_ORB, 0x01);
		registry.register(PacketType.CLIENTBOUND_PLAY_SPAWN_WEATHER, 0x02);
		registry.register(PacketType.CLIENTBOUND_PLAY_SPAWN_LIVING, 0x03);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_ANIMATION, 0x06);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_UPDATE_TILE, 0x09);
		registry.register(PacketType.CLIENTBOUND_PLAY_BLOCK_ACTION, 0x0A);
		registry.register(PacketType.CLIENTBOUND_PLAY_BLOCK_CHANGE_SINGLE, 0x0B);
		registry.register(PacketType.CLIENTBOUND_PLAY_BOSS_BAR, 0x0C);
		registry.register(PacketType.CLIENTBOUND_PLAY_SERVER_DIFFICULTY, 0x0D);
		registry.register(PacketType.CLIENTBOUND_PLAY_TAB_COMPLETE, 0x0E);
		registry.register(PacketType.CLIENTBOUND_PLAY_CHAT, 0x0F);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY, 0x28);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_EXPERIENCE, 0x3D);
		registry.register(PacketType.CLIENTBOUND_PLAY_UPDATE_HEALTH, 0x3E);
		registry.register(PacketType.CLIENTBOUND_PLAY_SCOREBOARD_OBJECTIVE, 0x3F);
		registry.register(PacketType.CLIENTBOUND_PLAY_SET_PASSENGERS, 0x40);
		...
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_ATTRIBUTES, 0x4B);
		registry.register(PacketType.CLIENTBOUND_PLAY_ENTITY_EFFECT_ADD, 0x4C);
	}
