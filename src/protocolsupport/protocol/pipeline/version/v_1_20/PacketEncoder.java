...
import protocolsupport.protocol.packet.middle.impl.clientbound.login.v_20.LoginSuccess;
...
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__18.DeclareTags;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.Actionbar;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.BlockChangeSingle;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.CombatBegin;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.EntityAttributes;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.InventoryClose;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.InventoryHorseOpen;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.InventoryOpen;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.ResourcePack;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.SpawnPosition;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.SyncPing;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.TitleAnimation;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.TitleClear;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.TitleSubText;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.TitleText;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.UpdateMap;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.WorldBorderCenter;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.WorldBorderInit;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.WorldBorderLerpSize;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.WorldBorderSize;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.WorldBorderWarnDelay;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r1__20.WorldBorderWarnDistance;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r2__20.EntityDestroy;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r2__20.InventorySetItems;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_17r2__20.InventorySetSlot;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_18__20.BlockChangeAck;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_18__20.BlockTileUpdate;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_18__20.UpdateSimulationDistance;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.Advancements;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.BlockChangeMulti;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.BundleSeparator;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.ChangeDimension;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.ChunkData;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.ChunkLight;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.CombatDeath;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.CombatEnd;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.DeclareCommands;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.DeclareRecipes;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.EntityEffectAdd;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.EntityHurtAnimation;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.EntityHurtEvent;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.EntityMetadata;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.EntitySound;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.Explosion;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.GameFeatures;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.OfflineServerData;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.PlayerListRemoveEntry;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.PlayerListSetEntry;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.PlayerMessage;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.PlayerMessageDelete;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.SetPosition;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.SpawnEntity;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.StartGame;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.SystemMessage;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.SystemPlayerMessage;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.WorldParticle;
import protocolsupport.protocol.packet.middle.impl.clientbound.play.v_20.WorldSound;
...
public class PacketEncoder extends AbstractPacketEncoder<IClientboundMiddlePacketV20> {
	...
	public PacketEncoder(IPacketDataChannelIO io, NetworkDataCache cache) {
		...
		registry.register(NetworkState.PLAY, ClientBoundPacketType.PLAY_BUNDLE_SEPARATOR, BundleSeparator::new);
		...
		registry.register(NetworkState.PLAY, ClientBoundPacketType.PLAY_PLAYER_MESSAGE_DELETE, PlayerMessageDelete::new);
		...
		registry.register(NetworkState.PLAY, ClientBoundPacketType.PLAY_BLOCK_CHANGE_ACK, BlockChangeAck::new);
		...
		registry.register(NetworkState.PLAY, ClientBoundPacketType.PLAY_SERVER_DATA, OfflineServerData::new);
		registry.register(NetworkState.PLAY, ClientBoundPacketType.PLAY_GAME_FEATURES, GameFeatures::new);
	}
