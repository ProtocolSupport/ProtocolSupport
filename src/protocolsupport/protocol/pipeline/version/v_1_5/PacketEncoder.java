...
public class PacketEncoder extends AbstractPacketEncoder {
...

	{
		...
		registry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_SIGN_EDITOR_ID, NoopBlockOpenSignEditor.class);
		registry.register(NetworkListenerState.PLAY, ClientBoundPacket.PLAY_ENTITY_ATTRIBUTES_ID, NoopEntitySetAttributes.class);
	}
