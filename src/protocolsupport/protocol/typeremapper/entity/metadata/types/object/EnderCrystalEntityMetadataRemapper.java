...
public class EnderCrystalEntityMetadataRemapper extends BaseEntityMetadataRemapper {
	...
	public EnderCrystalEntityMetadataRemapper() {
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.EnderCrystal.TARGET, 7), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.EnderCrystal.SHOW_BOTTOM, 8), ProtocolVersionsHelper.UP_1_14);
