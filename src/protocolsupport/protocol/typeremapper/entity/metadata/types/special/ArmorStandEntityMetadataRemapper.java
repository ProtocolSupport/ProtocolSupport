...
public class ArmorStandEntityMetadataRemapper extends LivingEntityMetadataRemapper {
	...
	public ArmorStandEntityMetadataRemapper() {
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.ArmorStand.FLAGS, 13), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.ArmorStand.HEAD_ROT, 14), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.ArmorStand.BODY_ROT, 15), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.ArmorStand.LEFT_ARM_ROT, 16), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.ArmorStand.RIGHT_ARM_ROT, 17), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.ArmorStand.LEFT_LEG_ROT, 18), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.ArmorStand.RIGHT_LEG_ROT, 19), ProtocolVersionsHelper.UP_1_14);
