...
public class ShulkerEntityMetadataRemapper extends InsentientEntityMetadataRemapper {
	...
	public ShulkerEntityMetadataRemapper() {
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Shulker.DIRECTION, 14), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Shulker.ATTACHMENT_POS, 15), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Shulker.SHIELD_HEIGHT, 16), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Shulker.COLOR, 17), ProtocolVersionsHelper.UP_1_14);
