...
public class CreeperEntityMetadataRemapper extends InsentientEntityMetadataRemapper {
	...
	public CreeperEntityMetadataRemapper() {
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Creeper.STATE, 14), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Creeper.POWERED, 15), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Creeper.IGNITED, 16), ProtocolVersionsHelper.UP_1_14);
