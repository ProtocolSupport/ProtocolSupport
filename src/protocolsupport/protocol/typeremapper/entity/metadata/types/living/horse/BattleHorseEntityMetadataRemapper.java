...
public class BattleHorseEntityMetadataRemapper extends BaseHorseEntityMetadataRemapper {
	...
	public BattleHorseEntityMetadataRemapper() {
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.BattleHorse.VARIANT, 17), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.BattleHorse.ARMOR, 18), ProtocolVersionsHelper.UP_1_14);
