...
public class ZombieVillagerEntityMetadataRemapper extends ZombieEntityMetadataRemapper {
	...
	public ZombieVillagerEntityMetadataRemapper() {
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.ZombieVillager.CONVERTING, 17), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.ZombieVillager.VDATA, 18), ProtocolVersionsHelper.UP_1_14);
		addRemap(new IndexValueRemapperVillagerDataToVarInt(DataWatcherObjectIndex.ZombieVillager.VDATA, 16), ProtocolVersionsHelper.RANGE__1_11__1_13_2);
	}
