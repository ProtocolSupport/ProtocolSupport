...
public class PigEntityMetadataRemapper extends AgeableEntityMetadataRemapper {
	...
	public PigEntityMetadataRemapper() {
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Pig.HAS_SADLLE, 15), ProtocolVersionsHelper.UP_1_14);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Pig.BOOST_TIME, 16), ProtocolVersionsHelper.UP_1_14);
