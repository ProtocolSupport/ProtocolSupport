...
public class LegacyLamaEntityMetadataRemapper extends CargoHorseEntityMetadataRemapper {

	public LegacyLamaEntityMetadataRemapper() {
		addRemap(new IndexValueRemapperNumberToSVarInt(DataWatcherObjectIndex.Lama.VARIANT, PeMetaBase.VARIANT), ProtocolVersion.MINECRAFT_PE);
		//addRemap(new IndexValueRemapperNumberToByte(DataWatcherObjectIndex.Lama.CARPET_COLOR, 3), ProtocolVersion.MINECRAFT_PE); TODO: Carpet Color. Done via slots instead?
		addRemap(new IndexValueRemapperNumberToSVarInt(DataWatcherObjectIndex.Lama.STRENGTH, PeMetaBase.STRENGTH), ProtocolVersion.MINECRAFT_PE); //TODO: Should max strength also be added?
