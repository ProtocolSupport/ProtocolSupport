...
public class ZombieEntityMetadataRemapper extends InsentientEntityMetadataRemapper {
	...
	public ZombieEntityMetadataRemapper() {
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Zombie.BABY, 14), ProtocolVersionsHelper.UP_1_14);
...
//		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Zombie.HANDS_UP, 14), ProtocolVersionsHelper.ALL_1_9);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Zombie.DROWNING, 16), ProtocolVersionsHelper.UP_1_14);
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Zombie.DROWNING, 15), ProtocolVersionsHelper.ALL_1_13);
	}
