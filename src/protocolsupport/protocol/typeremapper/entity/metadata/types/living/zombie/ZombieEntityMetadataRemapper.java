...
public class ZombieEntityMetadataRemapper extends InsentientEntityMetadataRemapper {
	...
	public ZombieEntityMetadataRemapper() {
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Zombie.BABY, 12), ProtocolVersionsHelper.RANGE__1_10__1_13_1);
		...
		addRemap(new IndexValueRemapperNoOp(DataWatcherObjectIndex.Zombie.HANDS_UP, 14), ProtocolVersionsHelper.RANGE__1_11__1_13_1);
