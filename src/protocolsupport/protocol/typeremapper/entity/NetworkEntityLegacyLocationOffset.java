...
@Preload
public class NetworkEntityLegacyLocationOffset {

	protected static final Map<ProtocolVersion, NetworkEntityLegacyLocationOffset> registry = new EnumMap<>(ProtocolVersion.class);
	static {
		for (ProtocolVersion version : ProtocolVersionsHelper.ALL) {
			registry.put(version, new NetworkEntityLegacyLocationOffset());
		}
	}

	public static NetworkEntityLegacyLocationOffset get(ProtocolVersion version) {
