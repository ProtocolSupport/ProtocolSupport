...
public class TridentNetworkEntityMetadataFormatTransformerFactory extends ArrowEntityNetworkEntityMetadataFormatTransformerFactory {
	...
	protected TridentNetworkEntityMetadataFormatTransformerFactory() {
		add(new NetworkEntityMetadataObjectIndexValueNoOpTransformer(NetworkEntityMetadataObjectIndex.Trident.LOYALTY, 9), ProtocolVersionsHelper.UP_1_16);
		...
		add(new NetworkEntityMetadataObjectIndexValueNoOpTransformer(NetworkEntityMetadataObjectIndex.Trident.HAS_GLINT, 10), ProtocolVersionsHelper.UP_1_16);
