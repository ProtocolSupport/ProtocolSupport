...
public class VillagerNetworkEntityMetadataFormatTransformerFactory extends AbstractMerchantNetworkEntityMetadataFormatTransformerFactory {
	...
	protected VillagerNetworkEntityMetadataFormatTransformerFactory() {
		...
		add(new NetworkEntityMetadataObjectIndexValueVillagerDataToVarIntTransformer(NetworkEntityMetadataObjectIndex.Villager.VDATA, 13), ProtocolVersionsHelper.RANGE__1_10__1_13_2);
		add(new NetworkEntityMetadataObjectIndexValueVillagerDataToVarIntTransformer(NetworkEntityMetadataObjectIndex.Villager.VDATA, 12), ProtocolVersionsHelper.ALL_1_9);
