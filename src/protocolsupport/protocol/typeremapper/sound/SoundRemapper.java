...
import protocolsupport.protocol.typeremapper.id.RemappingRegistry.StringRemappingRegistry;
...
public class SoundRemapper {
	...
	public static final StringRemappingRegistry<HashMapBasedStringRemappingTable> SOUND_REMAPPING_REGISTRY = new StringRemappingRegistry<HashMapBasedStringRemappingTable>() {
		{
			...
			registerRemapEntry("entity.player.hurt_on_fire", "game.player.hurt", ProtocolVersionsHelper.BEFORE_1_12);
		}
		@Override
		protected HashMapBasedStringRemappingTable createTable() {
			return new HashMapBasedStringRemappingTable();
		}
