...
import protocolsupport.protocol.typeremapper.itemstack.clientbound.BookPagesSpecificRemapper;
...
import protocolsupport.protocol.typeremapper.itemstack.clientbound.PotionNBTSpecificRemapper;
...
public class ItemStackRemapper {
	...
	static {
		...
		register(Material.POTION, new PotionNBTSpecificRemapper(false), ProtocolVersionsHelper.BEFORE_1_9);
		register(Material.SPLASH_POTION, new PotionNBTSpecificRemapper(true), ProtocolVersionsHelper.BEFORE_1_9);
		register(Material.LINGERING_POTION, new PotionNBTSpecificRemapper(true), ProtocolVersionsHelper.BEFORE_1_9);
		register(Material.WRITTEN_BOOK, new BookPagesSpecificRemapper(), ProtocolVersionsHelper.BEFORE_1_8);
