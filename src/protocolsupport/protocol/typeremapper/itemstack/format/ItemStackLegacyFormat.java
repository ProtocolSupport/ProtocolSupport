...
import protocolsupport.protocol.typeremapper.itemstack.format.from.ItemStackLegacyFormatOperatorAttributesFromLegacy;
import protocolsupport.protocol.typeremapper.itemstack.format.from.ItemStackLegacyFormatOperatorBannerFromLegacy;
import protocolsupport.protocol.typeremapper.itemstack.format.from.ItemStackLegacyFormatOperatorDisplayNameFromLegacyText;
import protocolsupport.protocol.typeremapper.itemstack.format.from.ItemStackLegacyFormatOperatorEnchantFromLegacyId;
import protocolsupport.protocol.typeremapper.itemstack.format.from.ItemStackLegacyFormatOperatorItemDurabilityFromLegacyData;
import protocolsupport.protocol.typeremapper.itemstack.format.from.ItemStackLegacyFormatOperatorLoreFromLegacyText;
import protocolsupport.protocol.typeremapper.itemstack.format.from.ItemStackLegacyFormatOperatorMapFromLegacyId;
import protocolsupport.protocol.typeremapper.itemstack.format.from.ItemStackLegacyFormatOperatorPotionFromLegacyId;
import protocolsupport.protocol.typeremapper.itemstack.format.from.ItemStackLegacyFormatOperatorShieldFromLegacy;
import protocolsupport.protocol.typeremapper.itemstack.format.from.ItemStackLegacyFormatOperatorSpawnEggFromIntId;
import protocolsupport.protocol.typeremapper.itemstack.format.from.ItemStackLegacyFormatOperatorSpawnEggFromStringId;
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorAttributesToLegacy;
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorBannerToLegacy;
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorBedToLegacy;
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorBookPagesToLegacyText;
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorDisplayNameToLegacyText;
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorEnchantToLegacyId;
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorItemDurabilityToLegacyData;
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorLoreToLegacyText;
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorMapToLegacyId;
...
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorPotionToLegacyId;
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorShieldToLegacy;
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorSpawnEggToIntId;
import protocolsupport.protocol.typeremapper.itemstack.format.to.ItemStackLegacyFormatOperatorSpawnEggToStringId;
