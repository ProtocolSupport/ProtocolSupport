...
public class SoundTransformer {
	...
	public static final GenericMappingRegistry<String, GenericMappingTable<String>> REGISTRY = new GenericMappingRegistry<>() {
		{
	...
	public static String getSoundName(ProtocolVersion version, String name) {
		return REGISTRY.getTable(version).get(name);
	}
