...
public class I18NData {
	...
	protected static final Set<String> builtInLocales = Utils.getResourceBuffered(resource_path + "languages").lines().collect(Collectors.toSet());
	...
	public static I18N loadBuiltInI18N(String locale) {
		...
		return loadAndRegisterI18N(locale, Utils.getResourceBuffered(resource_path + locale + ".json"));
	}
