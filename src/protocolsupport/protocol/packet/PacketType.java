...
public enum PacketType {
	...
	SERVERBOUND_PLAY_RECIPE_BOOK_RECIPE(Direction.SERVERBOUND, ServerPlatform.get().getPacketFactory().getInPlayRecipeBookRecipePacketId()),
	SERVERBOUND_PLAY_RECIPE_BOOK_STATE(Direction.SERVERBOUND, ServerPlatform.get().getPacketFactory().getInPlayRecipeBookStatePacketId()),
