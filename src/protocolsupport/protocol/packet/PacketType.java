...
public class PacketType {
	...
	public static final PacketType CLIENTBOUND_PLAY_LOGIN = new PacketType(Direction.CLIENTBOUND, ServerPlatform.get().getPacketFactory().getOutPlayLoginPacketId());
	...
	public static final PacketType CLIENTBOUND_PLAY_UPDATE_HEALTH = new PacketType(Direction.CLIENTBOUND, ServerPlatform.get().getPacketFactory().getOutPlayUpdateHealthPacketId());
	...
	public static final PacketType CLIENTBOUND_PLAY_ANIMATION = new PacketType(Direction.CLIENTBOUND, ServerPlatform.get().getPacketFactory().getOutPlayAnimationPacketId());
	...
	public static final PacketType CLIENTBOUND_PLAY_ENTITY = new PacketType(Direction.CLIENTBOUND, ServerPlatform.get().getPacketFactory().getOutPlayEntityPacketId());
	...
	public static final PacketType CLIENTBOUND_PLAY_EXPERIENCE = new PacketType(Direction.CLIENTBOUND, ServerPlatform.get().getPacketFactory().getOutPlayExperiencePacketId());
	...
	public static final PacketType CLIENTBOUND_PLAY_SPAWN_WEATHER = new PacketType(Direction.CLIENTBOUND, ServerPlatform.get().getPacketFactory().getOutPlaySpawnWeatherPacketId());
	...
	public static final PacketType CLIENTBOUND_PLAY_MAP = new PacketType(Direction.CLIENTBOUND, ServerPlatform.get().getPacketFactory().getOutPlayMapPacketId());
	public static final PacketType CLIENTBOUND_PLAY_UPDATE_TILE = new PacketType(Direction.CLIENTBOUND, ServerPlatform.get().getPacketFactory().getOutPlayUpdateTilePacketId());
	...
	public static final PacketType CLIENTBOUND_PLAY_ABILITIES = new PacketType(Direction.CLIENTBOUND, ServerPlatform.get().getPacketFactory().getOutPlayAbilitiesPacketId());
	...
	public static final PacketType CLIENTBOUND_PLAY_SET_PASSENGERS = new PacketType(Direction.CLIENTBOUND, ServerPlatform.get().getPacketFactory().getOutPlaySetPassengersPacketId());
