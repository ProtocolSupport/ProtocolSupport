...
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.handshake.v_1_7_1_8.SetProtocol;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.login.v_1_4_1_5_1_6_1_7_1_8.EncryptionResponse;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.login.v_1_7_1_8.LoginStart;
...
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_6_1_7_1_8.PlayerAbilities;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_7_1_8.ClientCommand;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.Animation;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.BlockDig;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.BlockPlace;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.ClientSettings;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.CustomPayload;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.EntityAction;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.KeepAlive;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.Position;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.PositionLook;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.ResourcePackStatus;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.Spectate;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.SteerVehicle;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.TabComplete;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.UpdateSign;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.play.v_1_8.UseEntity;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.status.v_1_7_1_8.Ping;
import protocolsupport.protocol.packet.middlepacketimpl.serverbound.status.v_1_7_1_8.ServerInfoRequest;
