...
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.BlockAction;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.BlockBreakAnimation;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.BlockChangeSingle;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.BlockOpenSignEditor;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.Chat;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.EntityTeleport;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.Login;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.Map;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.Position;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.ResourcePack;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.SpawnNamed;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.SpawnObject;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.SpawnPainting;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.SpawnPosition;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7.UseBed;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7_1_8.Animation;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7_1_8.Explosion;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7_1_8.GameStateChange;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7_1_8.HeldSlot;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7_1_8.KickDisconnect;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7_1_8.Respawn;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7_1_8.SpawnExpOrb;
import protocolsupport.protocol.packet.middleimpl.clientbound.play.v_1_7_1_8.SpawnGlobal;
