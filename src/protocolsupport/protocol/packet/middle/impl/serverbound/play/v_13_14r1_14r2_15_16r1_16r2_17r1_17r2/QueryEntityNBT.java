...
import protocolsupport.protocol.packet.middle.base.serverbound.play.MiddleQueryEntityNBT;
...
public class QueryEntityNBT extends MiddleQueryEntityNBT implements
...
IServerboundMiddlePacketV17r2 {
	...
	public QueryEntityNBT(IMiddlePacketInit init) {
		super(init);
	}
