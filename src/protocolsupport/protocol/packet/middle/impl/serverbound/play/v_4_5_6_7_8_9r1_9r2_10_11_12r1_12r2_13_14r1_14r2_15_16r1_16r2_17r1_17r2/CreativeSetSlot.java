...
import protocolsupport.protocol.packet.middle.base.serverbound.play.MiddleCreativeSetSlot;
...
public class CreativeSetSlot extends MiddleCreativeSetSlot implements
...
IServerboundMiddlePacketV17r2 {
	...
	public CreativeSetSlot(IMiddlePacketInit init) {
		super(init);
	}
	...
	protected void read(ByteBuf clientdata) {
		...
		itemstack = ItemStackCodec.readItemStack(clientdata, version);
	}
