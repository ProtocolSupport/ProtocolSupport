...
import protocolsupport.protocol.packet.middle.base.serverbound.play.MiddleSteerBoat;
...
public class SteerBoat extends MiddleSteerBoat implements
...
IServerboundMiddlePacketV20 {
	...
	public SteerBoat(IMiddlePacketInit init) {
		super(init);
	}
