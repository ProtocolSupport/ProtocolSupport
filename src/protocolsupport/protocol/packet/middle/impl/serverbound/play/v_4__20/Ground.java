...
import protocolsupport.protocol.packet.middle.base.serverbound.play.MiddleGround;
...
public class Ground extends MiddleGround implements
...
IServerboundMiddlePacketV20 {
	...
	public Ground(IMiddlePacketInit init) {
		super(init);
	}
