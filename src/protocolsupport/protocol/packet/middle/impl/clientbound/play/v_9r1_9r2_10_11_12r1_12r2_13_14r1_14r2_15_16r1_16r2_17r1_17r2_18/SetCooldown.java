...
import protocolsupport.protocol.packet.middle.base.clientbound.play.MiddleSetCooldown;
...
public class SetCooldown extends MiddleSetCooldown implements
...
IClientboundMiddlePacketV18 {
	...
	public SetCooldown(IMiddlePacketInit init) {
		super(init);
	}
	...
	protected void write() {
		...
		io.writeClientbound(setcooldown);
	}
