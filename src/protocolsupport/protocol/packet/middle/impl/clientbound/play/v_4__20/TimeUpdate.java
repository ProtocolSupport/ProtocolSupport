...
import protocolsupport.protocol.packet.middle.base.clientbound.play.MiddleTimeUpdate;
...
public class TimeUpdate extends MiddleTimeUpdate implements
...
IClientboundMiddlePacketV20 {
	...
	public TimeUpdate(IMiddlePacketInit init) {
		super(init);
	}
	...
	protected void write() {
		...
		io.writeClientbound(timeupdate);
	}
