...
public abstract class AbstractUnsignedSystemPlayerMessage extends MiddleSystemPlayerMessage {

	protected AbstractUnsignedSystemPlayerMessage(IMiddlePacketInit init) {
		super(init);
	}
	...
	protected BaseComponent getMessage() {
		...
		for (String parameterName : chattype.translationParameters()) {
			parameters.add(switch (parameterName) {
				...
				case NetworkChatType.PARAMETER_CONTENT -> message;
