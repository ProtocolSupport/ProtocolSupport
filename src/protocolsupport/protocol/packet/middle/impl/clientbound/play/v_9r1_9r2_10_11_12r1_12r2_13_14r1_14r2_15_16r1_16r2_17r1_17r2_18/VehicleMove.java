...
import protocolsupport.protocol.packet.middle.base.clientbound.play.MiddleVehicleMove;
...
public class VehicleMove extends MiddleVehicleMove implements
...
IClientboundMiddlePacketV18 {
	...
	public VehicleMove(IMiddlePacketInit init) {
		super(init);
	}
	...
	protected void write() {
		...
		io.writeClientbound(vehiclemove);
	}
