package protocolsupport.protocol.packet.middle.impl.clientbound.play.v_8__16r2;

import protocolsupport.protocol.codec.VarNumberCodec;
import protocolsupport.protocol.packet.ClientBoundPacketData;
import protocolsupport.protocol.packet.ClientBoundPacketType;
import protocolsupport.protocol.packet.middle.base.clientbound.play.MiddleWorldBorderLerpSize;
...
public class WorldBorderLerpSize extends MiddleWorldBorderLerpSize implements
...
IClientboundMiddlePacketV16r2 {
	...
	public WorldBorderLerpSize(IMiddlePacketInit init) {
		super(init);
	}
	...
	protected void write() {
		...
		VarNumberCodec.writeVarInt(worldborderPacket, 1); //action (1 - lerp size)
