...
public class CraftRecipeConfirm extends MiddleCraftRecipeConfirm implements
...
IClientboundMiddlePacketV18 {
	...
	public CraftRecipeConfirm(IMiddlePacketInit init) {
		super(init);
	}
	...
	protected void write() {
		...
		io.writeClientbound(craftrecipeconfirm);
	}
