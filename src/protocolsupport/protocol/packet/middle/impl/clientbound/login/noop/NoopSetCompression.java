package protocolsupport.protocol.packet.middle.impl.clientbound.login.noop;
...
public class NoopSetCompression extends MiddleSetCompression implements
...
IClientboundMiddlePacketV17r2 {
	...
	public NoopSetCompression(IMiddlePacketInit init) {
		super(init);
	}
