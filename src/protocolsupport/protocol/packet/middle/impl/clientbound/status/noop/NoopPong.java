package protocolsupport.protocol.packet.middle.impl.clientbound.status.noop;
...
public class NoopPong extends MiddlePong implements
...
IClientboundMiddlePacketV17r2 {
	...
	public NoopPong(IMiddlePacketInit init) {
		super(init);
	}
