...
public abstract class MiddleUpdateStructureBlock extends ServerBoundMiddlePacket {
	...
	protected MiddleUpdateStructureBlock(IMiddlePacketInit init) {
		super(init);
	}
	...
	protected void write() {
		io.writeServerbound(create(position, action, mode, name, offsetX, offsetY, offsetZ, sizeX, sizeY, sizeZ, mirror, rotation, metadata, integrity, seed, flags));
	}
