...
public enum ServerBoundPacketType {
	...
	PLAY_CHAT_MESSAGE_ACK(ServerPlatform.get().getPacketFactory().getInPlayChatMessageAckPacketId()),
	PLAY_CHAT_SESSION(ServerPlatform.get().getPacketFactory().getInPlayChatSessionPacketId()),
	PLAY_CHAT_COMMAND(ServerPlatform.get().getPacketFactory().getInPlayChatCommandPacketId()),
	PLAY_CHAT_MESSAGE(ServerPlatform.get().getPacketFactory().getInPlayChatMessagePacketId()),
	...
	PLAY_RECIPE_BOOK_RECIPE(ServerPlatform.get().getPacketFactory().getInPlayRecipeBookRecipePacketId()),
	PLAY_RECIPE_BOOK_STATE(ServerPlatform.get().getPacketFactory().getInPlayRecipeBookStatePacketId()),
	...
	PLAY_JIGSAW_UPDATE(ServerPlatform.get().getPacketFactory().getInPlayJigsawUpdatePacketId()),
	PLAY_JIGSAW_GENERATE(ServerPlatform.get().getPacketFactory().getInPlayJigsawGenerateStructurePacketId()),
	PLAY_SYNC_PONG(ServerPlatform.get().getPacketFactory().getInPlaySyncPong());
