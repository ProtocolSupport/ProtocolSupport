...
public class ClientBoundPacket {
	...
	public static final int PLAY_UNLOCK_RECIPES = ServerPlatform.get().getPacketFactory().getOutPlayUnlockRecipes();
	public static final int PLAY_ADVANCEMENTS = ServerPlatform.get().getPacketFactory().getOutPlayAdvancements();
