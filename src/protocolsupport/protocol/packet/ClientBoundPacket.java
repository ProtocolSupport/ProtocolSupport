...
import net.minecraft.server.v1_10_R1.PacketPlayOutCombatEvent;
...
import net.minecraft.server.v1_10_R1.PacketPlayOutServerDifficulty;
...
import net.minecraft.server.v1_10_R1.PacketPlayOutVehicleMove;
...
public class ClientBoundPacket {
	...
	public static final int PLAY_ENTITY_LEASH_ID = getId(PacketPlayOutAttachEntity.class);
	...
	public static final int PLAY_SERVER_DIFFICULTY = getId(PacketPlayOutServerDifficulty.class);
	public static final int PLAY_COMBAT_EVENT = getId(PacketPlayOutCombatEvent.class);
	public static final int PLAY_BOSS_BAR = getId(PacketPlayOutBoss.class);
	public static final int PLAY_SET_COOLDOWN = getId(PacketPlayOutSetCooldown.class);
	public static final int PLAY_VEHICLE_MOVE = getId(PacketPlayOutVehicleMove.class);
