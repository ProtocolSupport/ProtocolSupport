...
public class EntityStatus extends MiddleEntityStatus {
	...
	public RecyclableCollection<ClientBoundPacketData> toData(ProtocolVersion version) {
		...
		ClientBoundPacketData entitystatus = ClientBoundPacketData.create(PEPacketIDs.ENTITY_EVENT, version);
		VarNumberSerializer.writeVarLong(entitystatus, entityId);
		...
		entitystatus.writeByte((byte) status);
		VarNumberSerializer.writeVarInt(entitystatus, 0);
		packets.add(entitystatus);
		return packets;
	}
