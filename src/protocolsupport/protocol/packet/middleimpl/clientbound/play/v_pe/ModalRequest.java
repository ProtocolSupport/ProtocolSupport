...
public class ModalRequest extends ClientBoundMiddlePacket {
	...
	public static ClientBoundPacketData create(int modalId, String modalJSON, ProtocolVersion version) {
		ClientBoundPacketData serializer = ClientBoundPacketData.create(PEPacketIDs.MODAL_REQUEST, version);
