...
public class InventoryOpen extends MiddleInventoryOpen {
	...
	public RecyclableCollection<? extends IPacketData> toData0() {
		...
		return RecyclableSingletonList.create(writeData(
			...
			windowId, wdata.getStringId(), LegacyChatJson.convert(version, cache.getAttributesCache().getLocale(), title), windowRemapper.toClientSlots(0)
		));
	}

	public static ClientBoundPacketData writeData(ClientBoundPacketData to, int windowId, String type, BaseComponent title, int slots) {
