...
import com.github.shevchik.protocolsupport.protocol.storage.LocalStorage;
import com.github.shevchik.protocolsupport.protocol.transformer.utils.LegacyUtils;
import com.github.shevchik.protocolsupport.protocol.transformer.utils.MapTransformer;
import com.github.shevchik.protocolsupport.protocol.transformer.utils.MapTransformer.ColumnEntry;
import com.github.shevchik.protocolsupport.protocol.transformer.v_1_5.remappers.BlockIDRemapper;
import com.github.shevchik.protocolsupport.protocol.transformer.v_1_5.remappers.EntityIDRemapper;
import com.github.shevchik.protocolsupport.protocol.transformer.v_1_5.remappers.ItemIDRemapper;
import com.github.shevchik.protocolsupport.protocol.transformer.v_1_5.remappers.MapColorRemapper;
import com.github.shevchik.protocolsupport.protocol.transformer.v_1_5.utils.ChunkUtils;
import com.github.shevchik.protocolsupport.protocol.transformer.v_1_5.utils.DataWatcherFilter;
import com.github.shevchik.protocolsupport.protocol.transformer.v_1_5.utils.VillagerTradeTransformer;
import com.github.shevchik.protocolsupport.protocol.watchedentity.WatchedLiving;
import com.github.shevchik.protocolsupport.protocol.watchedentity.WatchedObject;
import com.github.shevchik.protocolsupport.protocol.watchedentity.WatchedPlayer;
	...
	public void tranform(Channel channel, int packetId, Packet<PacketListener> packet, PacketDataSerializer serializer) throws IOException {
		...
		switch (packetId) {
			...
			case 0x0C: { //PacketPlayOutNamedEntitySpawn
				...
				serializer.writeBytes(DataWatcherFilter.filterEntityData(serializer.getVersion(), storage.getWatchedEntity(playerEntityId), Utils.toArray(packetdata.readBytes(packetdata.readableBytes()))));
				break;
			}
