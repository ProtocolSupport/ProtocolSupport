package com.github.shevchik.protocolsupport.protocol;
		...
		if ((itemstack == null) || (itemstack.getItem() == null)) {
			...
			switch (getVersion()) {
				...
				case MINECRAFT_1_6_2: {
					writeShort(com.github.shevchik.protocolsupport.protocol.transformer.v_1_6.remappers.ItemIDRemapper.replaceItemId(itemId));
					break;
				}
				case MINECRAFT_1_7_10:
				case MINECRAFT_1_7_5: {
					writeShort(com.github.shevchik.protocolsupport.protocol.transformer.v_1_7.remappers.ItemIDRemapper.replaceItemId(itemId));
					break;
				}
				case MINECRAFT_1_5_2: {
					writeShort(com.github.shevchik.protocolsupport.protocol.transformer.v_1_5.remappers.ItemIDRemapper.replaceItemId(itemId));
					break;
				}
				default: {
					writeShort(itemId);
