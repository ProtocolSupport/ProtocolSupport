...
public class InitialPacketDecoder extends ChannelInboundHandlerAdapter {
	...
	private static final EnumMap<ProtocolVersion, IPipeLineBuilder> pipelineBuilders = new EnumMap<ProtocolVersion, IPipeLineBuilder>(ProtocolVersion.class) {{
		put(ProtocolVersion.MINECRAFT_1_8, new com.github.shevchik.protocolsupport.protocol.transformer.v_1_8.PipeLineBuilder());
		put(ProtocolVersion.MINECRAFT_1_7_10, new com.github.shevchik.protocolsupport.protocol.transformer.v_1_7.PipeLineBuilder());
		put(ProtocolVersion.MINECRAFT_1_7_5, new com.github.shevchik.protocolsupport.protocol.transformer.v_1_7.PipeLineBuilder());
		put(ProtocolVersion.MINECRAFT_1_6_4, new com.github.shevchik.protocolsupport.protocol.transformer.v_1_6.PipeLineBuilder());
		put(ProtocolVersion.MINECRAFT_1_6_2, new com.github.shevchik.protocolsupport.protocol.transformer.v_1_6.PipeLineBuilder());
		put(ProtocolVersion.MINECRAFT_1_5_2, new com.github.shevchik.protocolsupport.protocol.transformer.v_1_5.PipeLineBuilder());
	}};
